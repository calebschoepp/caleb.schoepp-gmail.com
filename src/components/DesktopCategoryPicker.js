...
const offCSS =
  "text-lg select-none bg-transparent hover:bg-_purple text-_purple font-semibold hover:text-white py-2 px-4 border border-_purple hover:border-transparent rounded-full my-1 border border-transparent inline-block";
const onCSS =
